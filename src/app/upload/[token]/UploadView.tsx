...
const COPY = {
  de: {
    ...
    helpDesc: "Bei Fragen erreichen Sie uns unter info@hyponova.ch oder +41 79 130 70 00.",
  ...
  en: {
    ...
    helpDesc: "Contact us at info@hyponova.ch or +41 79 130 70 00 with any questions.",
